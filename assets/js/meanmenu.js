        ...
        return this.each(function() {
            ...
            var P = "",
                ...
                b = function() {
                    ...
                    if (o >= t) {
                        jQuery(p).addClass("mean-remove"), M = !0, jQuery(a).addClass("mean-container"), jQuery(".mean-container").prepend('<div class="mean-bar" id="mean-bar-mobile">' + C + '<a href="#nav" class="meanmenu-reveal" style="' + n + '">Show Navigation</a><nav class="mean-nav"></nav></div>');
                        var r = jQuery(e).html();
